...
JavaScript에서는 수학에서 사용하던 것과 비슷하게 여러가지 종류의 연산자를 통해 연산을 수행할 수 있습니다. 이 밖에 수학에서 보던 것과는 동작 방식이 달라서 입문자에게는 익숙하지 않은 연산자들도 많이 있습니다.
...
값 뿐만 아니라 **코드 뭉치**에 이름을 붙여서 **재사용**을 할 수도 있는데, 이를 함수라 부릅니다. JavaScript에는 함수를 선언할 수 있는 여러가지 방법이 있습니다.
