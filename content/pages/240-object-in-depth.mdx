...
이 때, **객체 자신이** 특정 속성을 가지고 있는지를 확인하기 위해 `Object.hasOwn()` 정적 메소드를 사용할 수 있습니다.
...
console.log(Object.hasOwn(obj, 'constructor')) // false
```

> **참고**: `Object.hasOwn()`은 ES2022에 추가된 메소드로, 이전의 `hasOwnProperty` 메소드보다 안전하고 사용하기 쉽습니다. 자세한 내용은 [객체](./180-object) 챕터를 참고하세요.
...
비슷한 객체의 복제가 빈번하게 이루어져야 하는 경우에는 [Immutable.js](https://immutable-js.com/)와 같은 라이브러리의 사용도 고려해 보시길 바랍니다.
